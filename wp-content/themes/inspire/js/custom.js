...
(function($){
	...
	theme = {
	 ...
	 $.supersized.themeVars = {
		...
		image_path			:	'http://localhost:8888/inspire/wp-content/themes/inspire/images/',				// Default image path
...
jQuery('#portfoliocontainer').infinitescroll({
    ...
    loading: {
        ...
        img: 'http://localhost:8888/inspire/wp-content/themes/inspire/images/loading.gif',
